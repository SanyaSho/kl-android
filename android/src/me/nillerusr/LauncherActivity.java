...
import com.valvesoftware.source.kl.R;
...
{
	public static String MOD_NAME = "kl";
	...
	private Intent prepareIntent( Intent i )
	{
		...
		if( argv.length() != 0 ) i.putExtra( "argv", argv );
	...
	public void startSource( View view )
	{
		...
		if( argv.contains( "-game" ) && MOD_NAME.equals( "kl" ) ) // kayf-life debil protection
		{
			new AlertDialog.Builder( this )
				.setTitle( R.string.kl_game_fatal_title )
				.setMessage( R.string.kl_game_fatal_desc )
		...
		new AlertDialog.Builder(this)
			...
			.setMessage( R.string.kl_source_engine_fatal )
			.setPositiveButton( R.string.srceng_launcher_ok, ( DialogInterface.OnClickListener )null )
			.show();
	}
