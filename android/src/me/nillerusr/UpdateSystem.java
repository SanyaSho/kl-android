...
public class UpdateSystem extends AsyncTask<String, Integer, String>
{
	...
	public UpdateSystem( Context context )
	{
		...
		commit = context.getResources().getString( R.string.kl_commit );

		git_url = context.getResources().getString( R.string.kl_update_url );
		apk_url = "2281488";
	}
	...
	private static String toString( InputStream inputStream )
	{
		...
		try
		{
			...
			// for( String d : update ){ Log.d( "YEE", d ); }
	...
	protected String doInBackground( String... params )
	{
		...
		try
		{
			...
			Log.d( "KL-UpdateSystem", String.format( "%s | %s", web_commit, commit ) );
